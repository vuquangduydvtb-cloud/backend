...
async function adminChangePassword(e) {
  e.preventDefault();
  const oldPass = document.getElementById('acp_old').value;
  const newPass = document.getElementById('acp_new').value;
  const confirmPass = document.getElementById('acp_confirm').value;
...
async function loadAdminBanners() {
  ...
  document.getElementById('bannersList').innerHTML = banners.length ? banners.map(b => `
...
async function loadAdminSettings() {
  ...
  document.getElementById('s_email').value = s.store_email || '';
